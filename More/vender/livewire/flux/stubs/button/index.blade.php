...
$classes = Flux::classes()
    ...
    ->add(match ($variant) { // Background color...
        'success' => 'bg-emerald-800 hover:bg-emerald-900 dark:bg-[var(--bg_green_10)] dark:hover:bg-[var(--bg_green_09)]',
    ...
    ->add(match ($variant) { // Text color...
        'success' => 'text-gray-100 dark:text-while',
    ...
    ->add(match ($variant) { // Border color...
        'success' => 'border border-zinc-200 hover:border-zinc-200 border-b-zinc-300/80 dark:border-zinc-600 dark:hover:border-zinc-600',
    ...
    ->add(match ($variant) { // Shadows...
        'success' => 'shadow-[inset_0px_1px_--theme(--color-white/.2)]',
    ...
    ->add(match ($variant) { // Grouped border treatments...
        'ghost' => '',
        'subtle' => '',
        'success' => '[[data-flux-button-group]_&]:border-s-0 [:is([data-flux-button-group]>&:first-child,_[data-flux-button-group]_:first-child>&)]:border-s-[1px]',
